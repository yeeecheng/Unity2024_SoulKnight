...
public class enemy_attack : monster_action
{
    ...
    public override void Attack() {
        ...
        if (timer2 >= attack_interval) {
            ...
            bullet_controller bullet = Instantiate(bulletprefab, transform.position + nor_direction, Quaternion.Euler(new Vector3(0, 0, angle))).GetComponent<bullet_controller>();
